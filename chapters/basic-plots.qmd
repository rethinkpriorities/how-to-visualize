...
There are two basic ways to construct a bar plot in `ggplot`. The first way is to use the raw data and have `ggplot` calculate the frequencies.[^basic-plots-1]

[^basic-plots-1]: Testing a footnote here.
